...
<template>
  <div class="h-full flex flex-col bg-white border-r border-gray-200 overflow-y-auto">
    <div class="p-4 border-b border-gray-200">
      <h2 class="text-lg font-semibold text-gray-800">Typography</h2>
    </div>
    ...
    <div class="p-4 space-y-6">
      ...
      <div>
        ...
        <div v-show="expanded.fonts" class="space-y-3 pt-2">
          <div class="space-y-2">
              <label class="block text-xs text-gray-500">English Font</label>
          ...
          <div class="space-y-2">
              <label class="block text-xs text-gray-500">Chinese Font</label>
      ...
      <div>
        ...
        <div v-show="expanded.h1" class="grid grid-cols-2 gap-2 pt-2">
            ...
            <div>
                <label class="block text-xs text-gray-500">Spacing Before</label>
                <UnitInput v-model="globalStyles.h1.marginTop" unit="em" placeholder="1" />
            </div>
            <div>
                <label class="block text-xs text-gray-500">Spacing After</label>
      ...
      <div>
        ...
        <div v-show="expanded.body" class="space-y-3 pt-2">
            ...
            <h4 class="text-xs font-medium text-gray-700 mt-2">Paragraph Layout</h4>
            <div class="grid grid-cols-2 gap-2">
                <div>
                    <label class="block text-xs text-gray-500">First Line Indent</label>
                    <UnitInput v-model="globalStyles.body.indent" unit="em" placeholder="2" />
                </div>
                <div>
                    <label class="block text-xs text-gray-500">Line Height</label>
